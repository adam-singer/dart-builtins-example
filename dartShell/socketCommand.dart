...
#library('socketCommandLib');
/** [COMMANDNAME] socketexample provides the [Key] to the running the socket demo */
String COMMANDNAME="socketexample";
/** [COMMAND] function runs the socket demo */
COMMAND([var args]) {
